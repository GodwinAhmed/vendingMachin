...
number_of_1r = int(input("How many 1 rand coins would you like to insert? "))
while number_of_1r < 0:
    number_of_1r = int(input("Please enter a positive number."))
number_of_2r = int(input("How many 2 rand coins would you like to insert? "))
while number_of_2r < 0:
    number_of_2r = int(input("Please enter a positive number."))
number_of_5r = int(input("How many 5 rand coins would you like to insert? "))
while number_of_5r < 0:
    number_of_5r = int(input("Please enter a positive number."))
number_of_10r = int(input("How many 10 rand notes would you like to insert? "))
while number_of_10r < 0:
    number_of_10r = int(input("Please enter a positive number."))

# Creating a variable to store the total amount of money inserted into the vending machine.
change = round(((number_of_1r * 1.0) + (number_of_2r * 2.0) + (number_of_5r * 5.0) + (number_of_10r * 10.00)),2)
...
product_1, product_1_price = "Flake", 5.55
product_2, product_2_price = "Wispa", 5.50
product_3, product_3_price = "Crunchie", 5.65
product_4, product_4_price = "Milky Bar", 4.35
product_5, product_5_price = "Boost", 4.65
...
while change > 0:
    ...
    if customer_choice == "Flake" or customer_choice == "flake" and change >= product_1_price:
        ...
        print ("You have this much money remaining: R", change)
    elif customer_choice == "Milky Bar" or customer_choice == "milky Bar" and change >= product_4_price:
        print ("You have chosen a", product_4, "these cost", product_4_price, "each,")
        change = round((change - product_4_price),2)
        milky_bars_bought = (milky_bars_bought + 1)
        print ("You have this much money remaining: R", change)
        ...
        print (product_4, "x", milky_bars_bought)
